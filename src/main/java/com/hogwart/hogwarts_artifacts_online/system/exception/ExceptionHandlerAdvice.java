package com.hogwart.hogwarts_artifacts_online.system.exception;

import com.hogwart.hogwarts_artifacts_online.system.Result;
...
public class ExceptionHandlerAdvice {
    ...
    Result handleArtifactOrWizardNotFoundException(ObjectNotFoundException ex) {
    ...
    Result handleAuthenticationException(Exception ex) {
        return new Result(false, StatusCode.UNAUTHORIZED, "username or passowrd is incorrect", ex.getMessage());
    }
